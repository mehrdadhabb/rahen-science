...
scientific_service_keyboard = [['پایان نامه', 'پروپوزال', 'مقاله '],
                               ['پیدا کردن ژورنال و سابمیت', 'چک کردن پلاجریسم'],
                               ['آنالیز آماری', 'پارافریزینگ', 'پکیج کامل دانشجویی (شامل تمامی موارد بالا)']]
scientific_service_list = ['پایان نامه', 'پروپوزال', 'آنالیز آماری', 'مقاله','پیدا کردن ژورنال و سابمیت', 'چک کردن پلاجریسم', 'پارافریزینگ', 'پکیج کامل دانشجویی']
...
no_article_list = ['پیدا کردن ژورنال و سابمیت', 'چک کردن پلاجریسم', 'پارافریزینگ', 'آنالیز آماری', 'ثبت اختراع', 'پروپوزال فناوری']
...
def no_article(update: Update, context: CallbackContext) -> int:
    ...
    update.message.reply_text('جهت ادامه فرایند سابمیت مرحله بعد no type را بزنید',
                              reply_markup=ReplyKeyboardMarkup(reply_keyboard, one_time_keyboard=True),
                              parse_mode="markdown")
...
def description(update: Update, context: CallbackContext) -> int:
    ...
    update.message.reply_text(
        ' لطفا کلی ورد مربوط به پروژه خود را آپلود کنید (ترجیحا فایل زیپ). در صورت عدم وجود فایل /skip :را بزنید',
        parse_mode="markdown")
